...
export interface Invoice {
  id: string; orgId: string; number: string; type: InvoiceType; status: InvoiceStatus; workOrderId: string | null; partOrderId: string | null; parentInvoiceId: string | null;
  ...
  zatcaUuid: string | null; zatcaHash: string | null; zatcaQr: string | null; zatcaStatus: ZatcaStatus; notesAr: string | null; voidedAt: Date | null; voidReason: string | null; createdAt: Date; lines: InvoiceLine[];
}
