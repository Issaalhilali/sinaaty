...
import { ESCROW_REPOSITORY, LEDGER_REPOSITORY, PAYMENT_REPOSITORY, PAYOUT_REPOSITORY, WEBHOOK_INBOX } from './domain/repositories';
...
import { EscrowPrismaRepository, LedgerPrismaRepository, PaymentPrismaRepository, PayoutPrismaRepository, WebhookInboxPrisma } from './infrastructure/prisma/payments.prisma-repositories';
...
@Module({
  imports: [ScheduleModule.forRoot(), IdentityModule, OrganizationsModule, WorkOrdersModule, InvoicingModule],
  controllers: [PaymentsController, AdminPaymentsController],
  providers: [
    EscrowService, PaymentsUseCases, EscrowUseCases, WalletUseCases, PaymentJobs, PspMockAdapter,
    { provide: PAYMENT_REPOSITORY, useClass: PaymentPrismaRepository }, { provide: ESCROW_REPOSITORY, useClass: EscrowPrismaRepository }, { provide: LEDGER_REPOSITORY, useClass: LedgerPrismaRepository }, { provide: PAYOUT_REPOSITORY, useClass: PayoutPrismaRepository }, { provide: WEBHOOK_INBOX, useClass: WebhookInboxPrisma },
