...
function LoginForm() {
  ...
  return <div className="min-h-screen grid place-items-center p-6"><div className="card w-full max-w-sm p-7">
    <div className="flex items-center gap-2.5 font-bold text-xl mb-6"><span className="grid h-9 w-9 place-items-center rounded-[11px] bg-seal shadow-[0_8px_18px_-6px_rgba(14,107,84,.6)]"><span className="h-3.5 w-3.5 rounded-full border-[2.5px] border-white" /></span>صناعية · الإدارة</div>
