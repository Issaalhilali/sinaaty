...
class AppScaffold extends StatelessWidget {
  final String title; final Widget body; final Widget? primaryAction; final List<PopupMenuEntry<String>>? moreItems; final ValueChanged<String>? onMore; final Widget? bottom; final Widget? leading; final String? subtitle;
  const AppScaffold({super.key, required this.title, required this.body, this.primaryAction, this.moreItems, this.onMore, this.bottom, this.leading, this.subtitle});
  @override
