...
class PrimaryButton extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final child = loading ? SizedBox(height: 22, width: 22, child: CircularProgressIndicator(strokeWidth: 2.5, color: secondary ? s.primary : s.onPrimary)) : Row(mainAxisSize: MainAxisSize.min, children: [if (icon != null) ...[Icon(icon, size: 20), const SizedBox(width: 8)], Text(label)]);
