...
abstract final class AppTheme {
  ...
  static ThemeData _build(Brightness b) {
    ...
    return base.copyWith(
      ...
      textTheme: base.textTheme.apply(fontFamily: fontFamily, bodyColor: scheme.onSurface, displayColor: scheme.onSurface).copyWith(headlineMedium: TextStyle(fontFamily: fontFamily, fontSize: 27, fontWeight: FontWeight.w700, color: scheme.onSurface, height: 1.35, letterSpacing: -.3), headlineSmall: TextStyle(fontFamily: fontFamily, fontSize: 23, fontWeight: FontWeight.w600, color: scheme.onSurface, height: 1.4), titleLarge: TextStyle(fontFamily: fontFamily, fontSize: 19, fontWeight: FontWeight.w600, color: scheme.onSurface, height: 1.45), titleMedium: TextStyle(fontFamily: fontFamily, fontSize: 16, fontWeight: FontWeight.w600, color: scheme.onSurface, height: 1.5), titleSmall: TextStyle(fontFamily: fontFamily, fontSize: 15, fontWeight: FontWeight.w600, color: scheme.onSurface, height: 1.5), bodyLarge: TextStyle(fontFamily: fontFamily, fontSize: 16, height: 1.6, color: scheme.onSurface), bodyMedium: TextStyle(fontFamily: fontFamily, fontSize: 14, height: 1.6, color: scheme.onSurface), labelSmall: TextStyle(fontFamily: fontFamily, fontSize: 12, letterSpacing: .4, color: scheme.onSurfaceVariant)),
    );
  }
}
