...
abstract final class AppTheme {
  ...
  static ThemeData _build(Brightness b) {
    ...
    final r = BorderRadius.circular(SinaatySpace.radius); final rl = BorderRadius.circular(SinaatySpace.radiusCard);
    return base.copyWith(
      ...
      cardTheme: CardThemeData(color: scheme.surface, elevation: 0, margin: EdgeInsets.zero, shape: RoundedRectangleBorder(borderRadius: rl, side: BorderSide(color: dark ? SinaatyColors.dLine : SinaatyColors.line))),
      ...
      textTheme: base.textTheme.apply(fontFamily: fontFamily, bodyColor: scheme.onSurface, displayColor: scheme.onSurface).copyWith(headlineMedium: TextStyle(fontFamily: fontFamily, fontSize: 24, fontWeight: FontWeight.w800, color: scheme.onSurface, height: 1.4), headlineSmall: TextStyle(fontFamily: fontFamily, fontSize: 20, fontWeight: FontWeight.w600, color: scheme.onSurface, height: 1.45), titleLarge: TextStyle(fontFamily: fontFamily, fontSize: 18, fontWeight: FontWeight.w600, color: scheme.onSurface, height: 1.45), titleMedium: TextStyle(fontFamily: fontFamily, fontSize: 16, fontWeight: FontWeight.w600, color: scheme.onSurface, height: 1.5), titleSmall: TextStyle(fontFamily: fontFamily, fontSize: 15, fontWeight: FontWeight.w600, color: scheme.onSurface, height: 1.5), bodyLarge: TextStyle(fontFamily: fontFamily, fontSize: 15, height: 1.65, color: scheme.onSurface), bodyMedium: TextStyle(fontFamily: fontFamily, fontSize: 14, height: 1.6, color: scheme.onSurface), labelLarge: TextStyle(fontFamily: fontFamily, fontSize: 13, fontWeight: FontWeight.w600, height: 1.3, color: scheme.onSurface), bodySmall: TextStyle(fontFamily: fontFamily, fontSize: 12.5, height: 1.6, color: scheme.onSurfaceVariant), labelSmall: TextStyle(fontFamily: fontFamily, fontSize: 12, color: scheme.onSurfaceVariant)),
    );
  }
}
