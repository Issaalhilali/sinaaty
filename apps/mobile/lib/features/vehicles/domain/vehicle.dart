class Vehicle {
  ...
  final int? makeId;
  /// نبض السيارة من سجلها: آخر صيانة مُسلَّمة، كم ضماناً سارياً، وهل فيها إصلاح مفتوح —
  /// البطاقة الباردة باسم السيارة وحده لا تقول لصاحبها شيئاً يستحق النظر.
  final DateTime? lastServiceAt; final String? lastServiceTitleAr; final int activeWarranties; final String? openWorkOrderId;
  const Vehicle({required this.id, this.vin, this.plate, this.makeAr, this.modelAr, this.year, this.colorAr, this.odometerKm, this.makeId, this.lastServiceAt, this.lastServiceTitleAr, this.activeWarranties = 0, this.openWorkOrderId});
