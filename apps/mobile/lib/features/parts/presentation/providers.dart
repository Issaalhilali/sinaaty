...
final partLabelsProvider = FutureProvider.autoDispose.family<Result<List<PartLabel>>, ({String orgId, String batch})>((ref, a) => ref.watch(partsRepositoryProvider).serials(orgId: a.orgId, batch: a.batch));
