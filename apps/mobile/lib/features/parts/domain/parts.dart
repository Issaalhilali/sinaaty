...
class PartBid { final String id; final String supplierOrgId; final String condition; final String unitPrice; final int quantity; final String deliveryFee; final int? etaHours; final int warrantyDays; final String? notesAr; final String status; final DateTime createdAt; final String? whereText; final String? distanceKm;
  /// صور القطعة كما رفعها المورّد — لقطعة مستعملة هي أهم من كل الأرقام مجتمعة.
  final List<String> mediaIds;
  const PartBid({required this.id, required this.supplierOrgId, required this.condition, required this.unitPrice, required this.quantity, required this.deliveryFee, this.etaHours, required this.warrantyDays, this.notesAr, required this.status, required this.createdAt, this.whereText, this.distanceKm, this.mediaIds = const []}); }
