...
/// نتيجة صفٍّ واحد من استيراد قائمة المركبات — كل صفٍّ يحمل مصيره، فالصفّ الخاطئ لا يُسقط الباقي.
class FleetImportRow { final int row; final String status; final String? vin; final String? plate; final String? errorAr; const FleetImportRow({required this.row, required this.status, this.vin, this.plate, this.errorAr}); bool get ok => status == 'created' || status == 'exists'; }
