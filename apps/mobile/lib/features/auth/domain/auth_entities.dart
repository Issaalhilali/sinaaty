...
class Me { final String id; final String? phone; final String? fullNameAr; final String? email; final String platformRole; final bool nafathVerified; final List<OrgMembership> orgs; const Me({required this.id, this.phone, this.fullNameAr, this.email, required this.platformRole, required this.nafathVerified, required this.orgs}); }
