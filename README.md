...
مكتملة: **الخطوات 0–22** — الخلفية كاملة (هوية/نفاذ، منشآت وKYB، مركبات وسجل السيارة، أوامر عمل موقّعة، فواتير ZATCA،
...
(عميل وورشة وموردون) + لوحة إدارة Next.js + خط CI/CD ومراقبة. التالي في `CLAUDE.md`: **الخطوة 23 (شاشات العميل: طلب قطعة، مقارنة العروض، محفظة الضمان، سطحة)**.
