...
مكتملة: **الخطوات 0–29** — الخلفية كاملة (هوية/نفاذ، منشآت وKYB، مركبات وسجل السيارة، أوامر عمل موقّعة، فواتير ZATCA،
...
(عميل وورشة وموردون) + لوحة إدارة Next.js + خط CI/CD ومراقبة. التالي في `CLAUDE.md`: **الخطوة 30 (التوسع: مدن متعددة، Meilisearch، ضبط الأداء والتكلفة)**.
