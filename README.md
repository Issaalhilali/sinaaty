...
مكتملة: **الخطوات 0–30 — خطة البناء كلها** — الخلفية كاملة (هوية/نفاذ، منشآت وKYB، مركبات وسجل السيارة، أوامر عمل موقّعة، فواتير ZATCA،
...
(عميل وورشة وموردون) + لوحة إدارة Next.js + خط CI/CD ومراقبة. ما بعد الخطة: بنود ما قبل الطيار في `docs/backlog.md` (مزوّدو التشغيل الحيّ، اختبار الاختراق الخارجي، بروفة PITR).
...
pnpm --filter api test:e2e            # على قاعدة التطوير
pnpm --filter api test:e2e:clean      # على قاعدة نظيفة تُبنى من الترحيلات (كما في CI)
```
